...
HashMap map = dao.select("select * from sbinfo where id="+id).get(0);%>
<head>
	<meta charset="UTF-8" />
				...
				<div class="row">
					...
					<div class="m-t-b clearfix">
						...
						<section class="col-xs-12 col-sm-8 col-md-9">
							<div class="container">
								<h3><%=map.get("title") %></h3>
								<h4><small>发布于：<%=map.get("savetime") %></small></h3>
								<h4><small><%=map.get("note") %></small></h4>
