								...
								<div class="panel panel-default">
									...
									<div id="checkout-collapse1" class="panel-collapse collapse in">
										<div class="panel-body">
											<form class="form-horizontal" role="form" name="form2" id="ff2" method="post" action="/lyjdzxpwsys/lyjdzxpwsys?ac=register">
												<div class="row">
													<div class="col-xs-12 col-sm-12 col-md-6">
														<div class="form-group stylish-input">
															<label for="inputFirstname" class="col-sm-4 col-lg-4 control-label required">用户名</label>
															<div class="col-sm-8 col-lg-8">
																<input type="text" class="form-control" id="username" name="username" onblur="validatorloginName()" required/>
															</div>
														</div>
														<div class="form-group stylish-input">
