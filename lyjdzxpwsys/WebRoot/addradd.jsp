									...
									<section class="col-xs-12 col-sm-8 col-md-9">
										<div class="row">
											<div id="frm-contact-us">
												<form id="contact-form" class="clearfix" role="form" method="post" action="/lyjdzxpwsys/lyjdzxpwsys?ac=addradd" >
													<div class="space10 visible-xs visible-sm"></div>
													<div class="col-xs-12 col-sm-12 col-md-5">
														<div class="form-group stylish-input">
															<label for="contactName" class="required">收货人姓名</label>
															<input type="text" class="form-control" id="shr" name="shr" required />
														</div>
														<div class="form-group stylish-input">
															<label for="contactEmail" class="required">收货人电话</label>
															<input type="text" class="form-control" id="shrtel" name="shrtel" required />
														</div>
														<div class="form-group stylish-input">
															<label for="contactSubject">收货人地址</label>
															<input type="text" class="form-control" name="shraddr" id="shraddr" required/>
														</div>
														<div class="col-xs-12 col-sm-12">
															<button class="btn btn-default btn-round pull-right">提   交</button>
														</div>
													</div>
