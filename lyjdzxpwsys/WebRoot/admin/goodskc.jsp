...
<%	 CommDAO dao = new CommDAO(); 
	 ...
	 String url = "/lyjdzxpwsys/admin/goodskc.jsp?1=1";
...
<div class="container_12">
                    ...
                    <thead>
						<tr>
							<th colspan="3" align="left">
								<form action="goodskc.jsp?f=f" method="post" class="form-inline">
						...
						<tr class="odd gradeX" align="center">
							<td><%=map.get("goodno") %></td>
					          ...
					          <td>
							    ...
							    <%if(Info.getkc(map.get("id").toString())<=10){ %>
							    <font color="red">(库存不足，请补仓)</font>
							    <%} %>
					          </td>
							<td align="center">
							<a href="goodskcadd.jsp?gid=<%=map.get("id") %>" title="入库">入库</a>
							</td>
						</tr>
						<%} %>
						<tr class="odd gradeX">
							<td class="right" colspan="6">${page.info }</td>
						</tr>
	...
	<script type="text/javascript">
        ...
        function Change_Select(){//当第一个下拉框的选项发生改变时调用该函数
          ...
          var url = "/webclothessalessys/webclothessalessys?ac=searchsontype&fprotype="+ escape(fprotype);
