...
<%	 CommDAO dao = new CommDAO(); 
	 ...
	 String url = "/lyjdzxpwsys/admin/yqlink.jsp?1=1";
                    ...
                    <thead>
						<tr>
							<th colspan="3" align="left">
								<form action="yqlink.jsp?f=f" method="post" class="form-inline">
					 ...
					 <%String did = request.getParameter("did");
					   ...
					   ArrayList<HashMap> list=(ArrayList)bean.getCollection();
						...
						<tr class="odd gradeX" align="center">
							...
							<td align="center">
							<a href="yqlinkedit.jsp?id=<%=map.get("id") %>">编辑</a>
							|
							<a href="yqlink.jsp?did=<%=map.get("id") %>" >删除</a>
							</td>
						</tr>
						<%} %>
						<tr class="odd gradeX">
