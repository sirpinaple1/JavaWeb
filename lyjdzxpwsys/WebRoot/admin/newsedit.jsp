...
<div class="container_12">
        ...
        <div class="grid_10">
            <div class="box round first fullpage">
                <h2>编辑</h2>
                <div class="block ">
                    <form id="form" action="/lyjdzxpwsys/lyjdzxpwsys?ac=newsedit&id=<%=id %>" method="post" enctype="multipart/form-data">
                    <table class="form">
                        <tr>
                            <td class="col1">
                                <label>标题</label>
                            ...
                            <td class="col2">
                                <input type="text" value="<%=map.get("title") %>" id="title" name="title" class="input-xlarge span12" required>
                            </td>
                        </tr>
                        <tr>
                            <td class="col1">
