...
<div class="container_12">
        ...
        <div class="grid_10">
            <div class="box round first fullpage">
                <h2>编辑</h2>
                <div class="block ">
                    <form id="form" action="/lyjdzxpwsys/lyjdzxpwsys?ac=goodsedit&id=<%=id %>" method="post" enctype="multipart/form-data">
                    <table class="form">
                        <tr>
                            <td class="col1">
                                <label>景点名称</label>
                        ...
                        <tr>
                            ...
                            <td class="col2">
                                <input type="text" value="<%=map.get("remark") %>" size="100" id="remark" name="remark" class="input-xlarge" required>
                            </td>
                        </tr>
                        <tr>
                            <td class="col1">
