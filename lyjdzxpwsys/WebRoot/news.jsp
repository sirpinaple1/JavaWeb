							...
							<div class="container">
								...
								<table class="tbl-cart" style="width: 100%">
									...
									<%
										...
										<tr>
											<td>
												<a class="entry-thumbnail" href="upfile/<%=newmap.get("img") %>" data-toggle="lightbox">
													<img src="upfile/<%=newmap.get("img") %>" alt="" />
												</a>
												<a class="entry-title" href="newsx.jsp?id=<%=newmap.get("id") %>"><%=newmap.get("title") %></a>
												
											</td>
											<td><h4><small><%=newmap.get("savetime") %></small></h3></td>
										</tr>
										<%} %>
										<tr>
											<td colspan="3"><h5><small>${page.info }</small></h5></td>
										</tr>
									</tbody>
								</table>
