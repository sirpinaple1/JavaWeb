									...
									<section class="col-xs-12 col-sm-8 col-md-9">
										<div class="row">
											<div id="frm-contact-us">
												<form id="contact-form" class="clearfix" role="form" method="post" action="/lyjdzxpwsys/lyjdzxpwsys?ac=pj&goodid=<%=goodid %>&ddid=<%=ddid %>" >
													<div class="space10 visible-xs visible-sm"></div>
													<div class="col-xs-12 col-sm-12">
														<div class="form-group stylish-input">
															<label for="contactMSG" class="required">评分</label>
														...
														<div class="form-group stylish-input">
															<label for="contactMSG" class="required">评价内容</label>
														...
														<div class="col-xs-12 col-sm-12">
															<button class="btn btn-default btn-round pull-right">提交</button>
														</div>
													</div>
