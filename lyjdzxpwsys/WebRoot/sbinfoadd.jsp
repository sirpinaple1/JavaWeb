									...
									<section class="col-xs-12 col-sm-8 col-md-9">
										<div class="row">
											<div id="frm-contact-us">
												<form id="contact-form" class="clearfix" role="form" method="post" action="/lyjdzxpwsys/lyjdzxpwsys?ac=sbadd" >
													<div class="space10 visible-xs visible-sm"></div>
													<div class="col-xs-12 col-sm-12 col-md-5">
														<div class="form-group stylish-input">
															<label for="contactName" class="required">标题</label>
															<input type="text" class="form-control" id="title" name="title" style="width: 500px" required />
														</div>
														<div class="form-group stylish-input">
															<label for="contactEmail" class="required">内容</label>
															<textarea id="editor_id" id="note" name="note" style="width:500px;height:400px;" ></textarea>
														</div>
