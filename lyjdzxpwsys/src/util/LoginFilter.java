...
public class LoginFilter implements Filter {
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
		...
		if ((!request.getServletPath().equals("/admin/login.action"))
				...
				&& (!request.getServletPath().equals("/admin/css/bootstrap/css/animate.css"))
				&& (!request.getServletPath().equals("/admin/css/bootstrap/css/bootstrap.min.css"))
				&& (!request.getServletPath().equals("/admin/css/bootstrap/css/style.css"))
				&& (!request.getServletPath().equals("/admin/css/bootstrap/css/style.css.map"))
				&& (!request.getServletPath().equals("/admin/css/bootstrap/css/animate.css"))
				&& (!request.getServletPath().equals("/admin/css/bootstrap/css/animate.css"))
				) {
			// 登陆页面无需过滤
